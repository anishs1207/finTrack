...
function Footer() {
    ...
    async function handleNewsLetterSubmit(event) {
        ...
        try {
            ...
            setEmail(""); // Clears the input after successful submission
        } catch (error) {
    ...
    //             {/* The Goal Section */}
    //             <div>
    //                 <h3 className="text-xl font-semibold mb-4">The Goal</h3>
    //                 <ul className="text-gray-300">
    //                     <li>Helping Youth track their expenses with ease</li>
    //                     <li>Join us in this</li>
    //                 </ul>
    //             </div>
